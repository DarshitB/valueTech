 ...
 */
function generateAVRReportHTML(formData, extraData, bgImageBase64) {
  return `
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="content-wrapper">
        <table>
            <tr>
                <td colspan="3">Ref. No. ${formData.ref_no_year}/${formData.ref_no_bank}/${formData.ref_no_code}/${formData.ref_no_id}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2">${formData.date_of_invoice_delivery_no || ''}</td>
            </tr>
            <tr>
                <th colspan="3">&nbsp;</th>
            </tr>
            ...
            <tr>
                <th style="width: 10%;">Lien of ${formData.bank_name || 'Bank'}</th>
            ...
            <tr>
                ...
                <td colspan="2"># MODEL NAME # CHASSIS NO. ${formData.chassis_no || 'NOT AVAILABLE'} # MACHINE SERIAL NO.
                    ${formData.machine_serial_no || 'NOT AVAILABLE'} / ENGINE NO ${formData.engine_no || 'NOT AVAILABLE'} / REG NO. ${formData.regn_no || 'NOT AVAILABLE'}</td>
            </tr>
            <tr>
                <th colspan="3">&nbsp;</th>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2">Fully Functional AT ${formData.installed_asset_whether_functional_or_not || ''}</td>
            </tr>
            <tr>
                <th colspan="3">&nbsp;</th>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2">${formData.invoice_purchase_order_no || 'NOT AVAILABLE'}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2">${formData.insurer_policy_no || 'NOT AVAILABLE'}</td>
            </tr>
            <tr>
                <th style="width: 10%;">Insurance Validity / Insured Value</th>
                <td colspan="2">${formData.insurance_validity_insured_value || 'NOT AVAILABLE'}</td>
            </tr>
            <tr>
                <th style="width: 10%;">Insurance Having Lien of ${formData.bank_name || 'Bank'}.</th>
                <td colspan="2">${formData.insurance_having_lien_of_bank || 'NOT AVAILABLE'}</td>
            </tr>
            <tr>
                <th style="width: 10%;">Total Crane Weight & capacity</th>
                <td colspan="2">${formData.total_crane_weight_capacity || 'NOT AVAILABLE'}</td>
            </tr>
            <tr>
            ...
            ${generateFlexibleFieldsForAVR(formData.flexible_fields || [], "PRESENT_PARTICULARS_OF_THE_MACHINE")}
            <tr>
                <th colspan="3">&nbsp;</th>
            </tr>
            <tr>
        ...
        <table style="margin: 0%;width: 100%;">
            ...
            <tr>
                <td colspan="2" style="border:none;">&nbsp;</td>
                <th style="width: 10%;border:none;">${formData.surveyor || ''}</th>
            </tr>
            <tr>
                <td colspan="2" style="border:none;">&nbsp;</td>
                <th style="width: 10%;border:none;">License No.:- ${formData.license_no || ''}</th>
            </tr>
            <tr>
                <td colspan="2" style="border:none;">&nbsp;</td>
                <th style="width: 10%;border:none;">${formData.surveyor_location || ''}</th>
            </tr>
        </table>
    </div>
</body>
