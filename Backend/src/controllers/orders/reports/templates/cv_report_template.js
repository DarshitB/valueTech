...
<head>
    <style>
        ...
        /* Single page: table should fill 100% height like CE report */
...
<body>
    <div class="content-wrapper">
            ...
            <tr class="general-details-row move-to-tbody">
        ...
        <tr>
            ...
            <td colspan="5" style="padding: 0;margin: 0;">
                <table style="margin: 0;border-collapse: collapse;width: 100%;">
                    <tr>
                        <td style="border-top: 0px;border-bottom: 0px;border-left:0px;">FRONT ${
                          formData.front_tyre_no
                        } TYRE</td>
                        ...
                        <td style="border-top: 0px;border-bottom: 0px;border-left:0px;">REAR ${
                          formData.rear_tyre_no
                        } TYRE</td>
                        <td style="border: 0px;">${
